...
class ViewAttendanceToday extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        return <<<SQL
            CREATE VIEW  `view_attendance_today` AS
            SELECT
                attends.id,
                attends.employee_id,
                attend_date,
            ...
            WHERE attends.attend_date = DATE(NOW())
    ...
    {
        return <<<SQL
             DROP VIEW IF EXISTS `view_attendance_today`;
        SQL;
    }
}
